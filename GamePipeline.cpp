...
namespace misc {
	GamePipeline::GamePipeline(
		...
		const PipelineConfigInfo& configInfo) : myDevice{device}{
	...
	void GamePipeline::defaultPipelineConfigInfo(PipelineConfigInfo& configInfo) {
		...
		//configInfo.bindingDescriptions = GameModel::Vertex::getBindingDescriptions();
		//configInfo.attributeDescriptions = GameModel::Vertex::getAttributeDescriptions();
