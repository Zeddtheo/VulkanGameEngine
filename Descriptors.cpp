...
namespace misc {
    ...
    std::unique_ptr<DescriptorSetLayout> DescriptorSetLayout::Builder::build() const {
        return std::make_unique<DescriptorSetLayout>(myDevice, bindings);
    }

    // *************** Descriptor Set Layout *********************

    DescriptorSetLayout::DescriptorSetLayout(
        GameDevice& myDevice, std::unordered_map<uint32_t, VkDescriptorSetLayoutBinding> bindings)
    ...
    std::unique_ptr<DescriptorPool> DescriptorPool::Builder::build() const {
        return std::make_unique<DescriptorPool>(myDevice, maxSets, poolFlags, poolSizes);
    }
