...
namespace misc {
    ...
    SimpleRenderSystem::SimpleRenderSystem(GameDevice& device, VkRenderPass renderPass)
        : myDevice{ device } {
    ...
    void SimpleRenderSystem::renderGameObjects(
        VkCommandBuffer commandBuffer, std::vector<GameObject>& gameObjects, const GameCamera& camera) {
