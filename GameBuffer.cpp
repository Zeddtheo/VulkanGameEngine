...
namespace misc {
     ...
     */
    VkDeviceSize GameBuffer::getAlignment(VkDeviceSize instanceSize, VkDeviceSize minOffsetAlignment) {
     ...
     *
     */
    void GameBuffer::writeToBuffer(void* data, VkDeviceSize size, VkDeviceSize offset) {
     ...
     */
    VkDescriptorBufferInfo GameBuffer::descriptorInfo(VkDeviceSize size, VkDeviceSize offset) {
     ...
     *
     */
    void GameBuffer::writeToIndex(void* data, int index) {
     ...
     *
     */
    VkResult GameBuffer::flushIndex(int index) { return flush(alignmentSize, index * alignmentSize); }
     ...
     */
    VkDescriptorBufferInfo GameBuffer::descriptorInfoForIndex(int index) {
     ...
     * @return VkResult of the invalidate call
     */
    VkResult GameBuffer::invalidateIndex(int index) {
